...
1. Main thread picks 1-2 sites, hands paths to `cavecrew-builder`.

1. `cavecrew-reviewer` audits the diff.
...
Subagents drop caveman → normal English for security warnings, irreversible-action confirmations, and any output where fragment ambiguity could be misread. Resume caveman aft