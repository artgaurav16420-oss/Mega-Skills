...
Mega-Skills skills override default system prompt behavior, but **user instructions always take precedence**:

1. **User's explicit instructions** (CLAUDE.md, GEMINI.md, AGENTS.md, direct requests) — highest priority

1. **Mega-Skills skills** — override default system behavior where they conflict
...
Instructions say WHAT, not HOW. "Add X" or "Fix Y" doesn't mean skip workflo