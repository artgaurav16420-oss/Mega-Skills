...
Activate this skill when dealing with complex, multi-layered problems that require deep reasoning, hypothesis testing, or creative exploration. This skill forces you to step out of "reactive" mode and into "deliberate" mode.
...
### 1. Initialize the Thought Loop

Before taking any action, announce: "Starting Sequential Thinking process to analyze [PROBLEM]."
...
Only provide the final answer or take the primary action once you have reached a conclusive "Success" state in your reasoning loop.
