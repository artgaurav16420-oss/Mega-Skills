...
{
  "mcp_servers": [
    { "type": "url", "name": "linear", "url": "[https://mcp.linear.app/mcp"]([https://mcp.linear.app/mcp")]([https://mcp.linear.app/mcp"))]([https://mcp.linear.app/mcp")))]([https://mcp.linear.app/mcp"))))]([https://mcp.linear.app/mcp")))))]([https://mcp.linear.app/mcp"))))))]([https://mcp.linear.app/mcp")))))))](https://mcp.linear.app/mcp")))))))) }
  ],
  "tools": [
...
```json
{
  ...
  "auth": {
    "type": "mcp_oauth",
    "mcp_server_url": "[https://mcp.notion.com/mcp",]([https://mcp.notion.com/mcp",)]([https://mcp.notion.com/mcp",))]([https://mcp.notion.com/mcp",)))]([https://mcp.notion.com/mcp",))))]([https://mcp.notion.com/mcp",)))))]([https://mcp.notion.com/mcp",))))))]([https://mcp.notion.com/mcp",)))))))](https://mcp.notion.com/mcp",))))))))
