  ...
  messages: [
    {
      ...
      content: [
        {
          type: "image",
          source: { type: "url", url: "[https://example.com/image.png"](https://e)xample.com/image.png")]([https://example.com/image.png"))](https://e)xample.com/image.png")))]([https://example.com/image.png"))))](https://e)xample.com/image.png")))))]([https://example.com/image.png"))))))](https://e)xample.com/image.png")))))))](https://example.com/image.png") },
        },
...
const estimatedInputCost = countResponse.input_tokens * 0.000005; // $5/1M token