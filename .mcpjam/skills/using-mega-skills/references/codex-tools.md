...
Claude Code skills reference named agent types like `mega-skills:code-reviewer`.
...
1. Fill any template placeholders (`{BASE_SHA}`, `{WHAT_WAS_IMPLEMENTED}`, etc.)
...
The agent can still run tests, stage files, and output suggested branc