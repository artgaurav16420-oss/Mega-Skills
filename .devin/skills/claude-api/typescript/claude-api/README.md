  ...
  messages: [
    {
      ...
      content: [
        {
          type: "image",
          source: { type: "url", url: "[https://example.com/image.png"]([https://example.com/image.png")]([https://example.com/image.png"))]([https://example.com/image.png")))]([https://example.com/image.png"))))]([https://example.com/image.png")))))]([https://example.com/image.png"))))))]([https://example.com/image.png")))))))](https://example.com/image.png")))))))) },
        },
