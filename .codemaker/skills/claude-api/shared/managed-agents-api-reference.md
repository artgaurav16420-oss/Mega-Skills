  ...
  "resources": [
    {
      ...
      "url": "[https://github.com/owner/repo]([https://github.com/owner/repo)]([https://github.com/owner/repo))]([https://github.com/owner/repo)))]([https://github.com/owner/repo))))]([https://github.com/owner/repo)))))]([https://github.com/owner/repo))))))]([https://github.com/owner/repo)))))))](https://github.com/owner/repo)))))))) (required)",
...
Files and Skills endpoints use the standard tier-based [rate limits]([https://platform.claude.com/docs/en/api/rate-limits).]([https://platform.claude.com/docs/en/api/rate-limits).)]([https://platform.claude.com/docs/en/api/rate-limits).))]([https://platform.claude.com/docs/en/api/rate-limits).)))]([https://platform.claude.com/docs/en/api/rate-limits).))))]([https://platform.claude.com/docs/en/api/rate-limits).)))))]([https://platform.claude.com/docs/en/api/rate-limits).))))))]([https://platform.claude.com/docs/en/api/rate-limits).)))))))](https://platform.claude.com/docs/en/api/rate-limits).))))))))
